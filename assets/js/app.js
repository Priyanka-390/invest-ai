...
document.addEventListener("DOMContentLoaded", function () {
  ...
  firstNameInput.addEventListener("input", () =>
    validateInput(firstNameInput, firstNameError, isValidName)
  );
  lastNameInput.addEventListener("input", () =>
    validateInput(lastNameInput, lastNameError, isValidName)
  );
  emailInput.addEventListener("input", () =>
    validateInput(emailInput, emailError, isValidEmail)
  );
  phoneInput.addEventListener("input", () =>
    validateInput(phoneInput, phoneError, isValidPhone)
  );
...
document.getElementById("countryCode").addEventListener("change", function () {
  ...
  if (flagImages[selectedOption]) {
    ...
    flagImage.src = "./assets/images/svg/canada-flag.svg"; 
  }
});
